...
\begin{document}
	...
	\begin{frame}{3.4 MONK 3 Results: Learning Curves}
		\begin{columns}
			\column{0.5\textwidth}
			\centering
			\begin{figure} 
...
\begin{figure} 
	...
	\begin{frame}{4.5 CUP: Inference and Refinement}
	...
	\begin{frame}{4.6 CUP: Ensemble $z_{ens}$}
	...
	\begin{frame}{5.2.1 CUP: Grid Search Summary}
